...
export class ReportsMapper {
  ...
  public static toPersistence(domainEntity: Reports): ReportsSchemaClass {
    ...
    if (domainEntity.site_id) {
      ...
      persistenceSchema.site_id = MiningSitesMapper.toPersistence(domainEntity.site_id);
    }
    
    if (domainEntity.province_id) {
      // Handle domain entity reference
      persistenceSchema.province_id = ProvincesMapper.toPersistence(domainEntity.province_id);
    }
    ...
    if (domainEntity.generated_by) {
      // Handle domain entity reference
      persistenceSchema.generated_by = AdminUsersMapper.toPersistence(domainEntity.generated_by);
    }
